...
\ifdissertation alignment. \else {\em alignment}~%
...
\fi
  ...
  not always exist, and second, development of a span-based analog for our
  lens equivalence (critical for the associativity of composition) requires
