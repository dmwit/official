...
interesting information. % TODO: this is enabled by...
This is an improvement on the asymmetric lens framework's need for a
canonical, centralized repository, but the behavior of many of the actual
lenses proposed in Chapter~\ref{chap:symmetric} remain undesirable in
several ways. Most significantly, they employ a somewhat na\"ive strategy
for divining the connection between original and updated repositories. This
manifests itself as lenses which follow the letter of the law---produce
synchronized repositories---but mangle the meaning of the repositories
during synchronization by inappropriately mixing and matching data.
...
Table~\ref{tab:related-commentary}; edit lenses is the first approach to
address all of the issues raised above.
...
Though the four issues identified above are important ones, there remain
