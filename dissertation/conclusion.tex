...
% TODO: Dad suggests:
% This point [about ``satisfactory progress may require a general theory for
% lifting parsing techniques''] should be repeated in your overall
% Conclusions Chapter, and also in the future work section of that chapter.
%
% There seem to be two points:
% 1. The theory does not include a formalism for parsing [ed: this should go
%    near ``we cover all four objectives'']
% 2. A good future work would be to extend the theory to include a
%    formalism for parsing [ed: this should go in future work]
% TODO: this paragraph basically needs to be completely rewritten now that
% we have a real implementation chapter
