...
that duplicates information, making it the only approach that makes a
serious attempt to handle alignment problems while enabling this lens. Finally,
...
%        TGGs            &\N&\Y&\N&\Y&\\
        ...
        \\\hline
        categorical     &\Y[inclusion morphisms]
                        &\N[no]
                        &\N[edits include repositories]
                        &\N[bespoke examples]
        \\\hline
