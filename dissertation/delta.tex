...
we then construct a symmetric edit lens $\partial_x \ell$ between the
modules $X_x$ and $Y_y$ 
as follows: 
(1) $(\partial_x\ell).C = \ell.C$;
(2) $(\partial_x\ell).\missing = c_0$;
(3) $(\partial_x\ell).\dputr_g = \ell.\putr$;
(4) $(\partial_x\ell).\dputl_g = \ell.\putl$; and
(5) $(\partial_x\ell).K = \{(x,c,y) \mid \ell.\putr(x,c)=(y,c)\}$.
\fi
$\partial_x \ell$ is a symmetric edit lens and the passage from $\ell$
to $\partial_x \ell$ is compatible with the equivalences on symmetric
...
\begin{theorem}
    ...
    $\partial_xk\equiv\partial_x\ell$.
\end{theorem}

\begin{proof}
Suppose $S$ is a witness that $k\equiv\ell$. Then we define
$\partial_xS$ as follows:
\[\partial_xS = \{(x,c_k,c_\ell,y) \mid (c_k,c_\ell) \in S
