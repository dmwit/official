...
respectively. Thus to restore consistency we apply $\mlrearrange(\ONE,f_i)$ where
...
definitions below.
%
The additional families of bijections $f_i, f_d, f_r$ must be chosen in such a
...
As discussed in the example above, the bijection $f_i$ contains a little
