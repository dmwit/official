...
\begin{theorem}
The $\partition$ defined in \partitionfigures is indeed a symmetric edit
lens.
...
\item {\bf Case \markref{rmodswitch}:}
    ...
    \begin{align*}
        \map_{\ml{tagof}}(\dz\;z)
            &= \map_{\ml{tagof}}(z_1\cdots z_{p-1}\mlinl{v'}z_{p+1}\cdots z_n) \\
            &= \map_{\ml{tagof}}(z_1\cdots z_{p-1})\;k\;\map_{\ml{tagof}}(z_{p+1}\cdots z_n)\\
...
\item {\bf Case \markref{rreorder}:} Before we begin, we address the two
    ...
    \begin{align}
        \map_{\ml{tagof}}(\dz\;z)
            &= \map_{\ml{tagof}}(z_{f(n)(1)}\cdots z_{f(n)(n)})
            \label{eq:reorder-z} \\
            &= \map_{\ml{tagof}}(z)_{f(n)(1)}\cdots\map_{\ml{tagof}}(z)_{f(n)(n)}
