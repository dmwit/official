...
\end{wrapfigure}
To restore consistency we also apply $\mlrearrange(\ONE,f_i)$ where
$f_i(i')=\{(\blist0\mlist0\elist,\blist0\elist)$, $(\blist0\elist,\NIL)$,
...
$f_i(i')= \{\dots, (\blist1\elist,\blist0\mlist1\elist)$,
$(\blist1\mlist1\elist,\blist0\mlist1\elist)\}$; this is precisely the
additional freedom of choice. Of course  $f_i(i'')$ for $i''\neq i'$ is also
completely unconstrained. After applying $\mlrearrange(\ONE,f_i)$ we end up
