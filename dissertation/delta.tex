...
\item {\bf Case \markref{lreorder}:} We have a slew of equalities in hand to
    ...
    part of what we need to show that $(\dz\;z,c',(\dx\;x,y))\in K$.

    Let us now turn our attention to showing that $\dz\;z$ and $\dx\;x$ have
    the appropriate relationship. \dmwit{proofneeded}

    Finally, we must show that $\dz\;z$ and $y$ have the appropriate
    relationship. \dmwit{proofneeded}
