% TODO: review homomorphism specification section and possibly the ``adding
%       laws'' section now that we have normalized on using specializations
%       of ``monoid homomorphism'' as the definition for actions, stateful
%       homomorphisms, etc.
...
example, the set of all total \ifdissertation(respectively, partial) \fi
functions from a set $X$ to itself forms a monoid, where the multiplication
operation is function composition\ifdissertation\ (and the unit is the
