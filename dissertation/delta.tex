...
These conditions do not completely determine $f_i$, $f_d$, and $f_r$. In
...
$f_i$ but by the family of bijections $f_{i,c',i'}$ that parameterize the
lens.
...
\begin{pf}
  ...
  \begin{align*}
    ...
    f_1'(p)&=\text{if }f_i(\di'\;i')(p)\in\live(i')\text{ then }f'(f_i(\di'\;i')(p))\text{ else }\init_X
  \end{align*}
