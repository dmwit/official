...
\begin{theorem}\ 
    \begin{itemize}
        ...
        \item $(k \oplus \ell);\bij_{\swap} \equiv \ell \oplus k$, where
            $\swap$ is the obvious module isomorphism between $X \oplus Y$
            and $Y \oplus X$.
    \end{itemize}
\end{theorem}
...
\begin{pf}\ 
    \begin{itemize}
        ...
        \item $(k\oplus\ell);(k'\oplus\ell')\equiv(k;k')\oplus(\ell;\ell')$
            ...
            embodied in the $\ml{split}$ function:
            \begin{align*}
                \ml{split}(\mlinl{(c,c')}) &= (\mlinl c,\mlinl{c'}) \\
                \ml{split}(\mlinr{(c,c')}) &= (\mlinr c,\mlinr{c'})
            \end{align*}
            Our witness relation uses this function.
            \[S = \{(x,\ml{split}(c),c,y) \mid (x,c,y) \in b.K\}\]
            \dmwit{proofneeded}
        ...
        \item $(k\oplus\ell);\bij_{\swap}\equiv\ell\oplus k$
            ...
            complements:
            \[S = \{(x,(\swap(c),\unit),c,y) \mid (x,c,y) \in (\ell\oplus
            k).K\}\]
            \dmwit{proofneeded}
            \endofpf
    \end{itemize}
