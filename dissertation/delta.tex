...
f_r(i')(p) &= f_{i,c,i'}^{-1}(g(i)(f_{\di\ i,c',\di'\ i'}(p)))
\end{align*}
...
$f_1(f_{post}(p))=\init_X$, too, by the characterization of $f_1$.
  ...
  are consistent are $(\di\;i,g(i);f)$ and $(\di'\;i',f_r(i');f')$. Consider
  ...
  \live(i)$; this justifies the first equation below.
    \begin{align*}
        f(g(i)(f_{post}(p))) &= f'(f_{pre}^{-1}(g(i)(f_{post}(p))))
            &&\mbox{consistency of }f\mbox{ and }f' \\
        &= f'(f_r(i')(p))
            &&\mbox{condition of }f_r
    \end{align*}
    \dmwit{rearrangements were the ``wrong way around'' in this case. are
        the other consistency conditions the right way around compared to
        their definitions?}
\end{pf}
\fi
