...
.
%
\hbox to 0pt{\hspace{\ifdissertation6.2em\else1.2em\fi} \endofpfmarker}
\end{array}
\]
\noendofpf
\end{pf}
...
\begin{proof}\ 
    ...
    \begin{itemize}
        ...
        \item Suppose $S$ is a witness that $k \equiv \ell$. Define $S'$ by
            ...
            quadruple
            \dissdis(\init_{X^*},k^*.\init,\ell^*.\init,\init_{Y^*})=(\varepsilon,\varepsilon,\varepsilon,\varepsilon)\dissdis
...
\begin{align*}
    ...
    ={}& \mllet (n_L,n_R) = \mlcount(p\mathord{-}1,c_2 \cdots c_n)
    \ifdissertation
        \\&\mlinb
    \else
        \mline\ 
...
$f_1'(p)=\init_X$, but then \dissdis f_1(f_{\di\ i,c',\di'\
i'}(p))=\init_X,\dissdis
