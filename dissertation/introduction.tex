...
\begin{diagram}[alignment diagram]
    \foreach \c in {c,a,m,l,C,a,s,e,d,W,o,r,d}
        {\node[on chain=source]{\c};}
    \node[on chain=intermediate,below=5ex of source-1] {c};
    \foreach \c in {a,m,l,c,a,s,e,d,w,o,r,d}
        {\node[on chain=intermediate]{\c};}
    \node[on chain=view,below=5ex of intermediate-1] {c};
    \foreach \c in {a,m,e,l,c,a,s,e,d,w,o,r,d}
        {\node[on chain=view]{\c};}
    \foreach \n in {1,...,13}
        {\draw (source-\n) -- (intermediate-\n);}
...
\texttt{diff}.
% TODO: change all examples from camelCasedWord to CapitalizedWord to avoid
% questions about swapping the first word with later ones
...
% TODO: perhaps everything here down is ``dead text'' now
