...
% TODO: write a paragraph explaining this figure
\begin{figure}
    \begin{diagram}
...
neither repository can be completely reconstructed just from the information
...
quite explicitly.
% TODO: we need to motivate why composition is so critical, so we should
% switch to an example that is complicated enough to need it
