...
we will have $\ell\LIST \in S\LIST \alens V\LIST$.
Figure~\ref{fig:naive-asymmetric-map} defines the $-\LIST$ lens, relying on some
auxiliary definitions given in Figure~\ref{fig:uni-map-zip-const}.
The \GET and \CREATE operations are fairly
...
repository, our $\ell\LIST.\aput$ operation takes two lists, of types
