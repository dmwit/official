...
subordinate. As we hoped, our commitment to this approach has resulted in an elegant core
...
lens theory in isolation from the issues of alignment and performance. The key
...
and performance problems (while retaining symmetry). Because the exact nature of
...
\label{sec:notation}
% TODO: transition; give the purpose of this section; etc.
