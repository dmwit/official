...
that reads and writes to those cells; the cells themselves are
``repositories'', while the values contained in the cells are repository
values and have types that match the lens' type.)
\begin{table}
    \centering
