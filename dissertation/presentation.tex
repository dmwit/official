...
\begin{frame}
    ...
    \end{itemize}
    An \emph{instance} $\left<X,i,f\right>$ of container $\left<I,P\right>$ is
    \begin{itemize}
        \item A set of elements $X$,
...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \item Universe of positions
        \item Partial order on shapes (with $P$ monotone)
    \end{itemize}
\end{frame}
