...
\begin{frame}
    \frametitle{Other results: algebraic study}
    % TODO: add a question to the list of potential pain points: why didn't
    % you try to recapitulate the symmetric lens exploration? e.g. why
    % didn't you study naturality of projection, existence of injections,
    % and explicitly prove products/sums don't exist?
    For edit lenses:
    \begin{itemize}
        \item Symmetric monoidal product structure
...
\begin{frame}
    ...
    \begin{itemize}
        \item Asymmetric lenses can be lifted to symmetric lenses (and
            lifting is compatible with many operators)
        ...
        \item Prototype implementation explores the generation of alignment
            information
        % TODO: add a question to the list: tell me more about the
        % implementation!
    \end{itemize}
\end{frame}

% TODO: some slides covering the conclusion (i.e. summarize what we did, say
% it was important, talk about future work, give a little context, and ask
% for questions)
