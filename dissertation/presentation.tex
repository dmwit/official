...
% TODO: maybe delete, and add a line to the ``other settings'' list on the
% next slide
\begin{frame}
...
% TODO: this slide needs some work on content and some thought about what
% you will say while it's up
\begin{frame}
...
% TODO: dad suggests putting more column lines
% TODO: really need to figure out what you're going to say here
\begin{frame}
...
% TODO: delete this slide now? doesn't seem that useful, really
\begin{frame}
...
% TODO: either delete these (if the talk is long enough) or flesh them out
% (in case we need a bit more material)
%\begin{frame}
...
% TODO: plan a transition from the results to here
% TODO: Nicole says I paused a lot on this slide, so work out what to say
% aloud
\begin{frame}
