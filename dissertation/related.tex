...
lens~\cite{hermann2011correctness}.

% TODO: but no examples of particular constructions that satisfy the given
% constraints or guidance on creating such

% TODO: model of edits is WHACK, which prevents both small edits and small
% complements

% TODO: SDInvertible neat, and perhaps future work can consider an edit lens
% analog and how often it's satisfied (seems plausible if we include some
% laws in our module presentations); SDUndo might be hard if we reject
% inverse edits as being too large but otherwise seems like a good idea
