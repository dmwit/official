...
% TODO: perhaps we can begin with a generic discussion of the model Diskin
% et al seem to have in mind for edits, and categorize the different
% kinds of structure they impose at various times -- like composition,
% undos, etc. -- before diving into the asymmetric/symmetric work. is there
% a sense of ``structure-preserving maps'' that simplifies the definitions
% of asymmetric/symmetric lenses somehow? at the very least we should
% probably unify the discussion a lot compared to how it's laid out
% currently. especially since one of our big criticisms of their work is
% that their delta model is typed, which kills the size argument, and that
% model is shared between the two papers.
