...
% TODO: yikes, \Mod(G) is not a module! we might be able to factor \id into
% f;g, but f\odot(g\odot x) will be ill-typed whereas \id\odot x succeeds
% because of the quotienting
...
\lensdef{delta_symmetrize}
    ...
    }
    {
        ...
        && \mbox{when }\mldom(\dv)=\ell.\aget_0(s) \land \dv \ne \ONE\\
...
% TODO: yikes, this is NOT an edit lens! (we might be able to factor \fail
% into \ds\ds' where \ds and \ds' are ill-typed, but get translated to
% well-typed \dv and \dv')
