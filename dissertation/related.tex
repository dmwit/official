...
state-based lenses which replace all or most of the repository data being
consumed or produced by a lens with edit information, instead. Symmetric
delta lenses extend asymmetric delta lenses with some significant additional
...
corresponds to an asymmetric lens is given, and Meertens proposes the use of
