...
administration tool, Augeas~\cite{Augeas}.  \bcp{Mention the Haskell lens libraries?}
...
lenses in two significant respects.  \bcp{We probably need some citations
  after 2010...}
...
in~\citeN{FosterThesis} and~\citeN{DBLP:conf/icmt/CzarneckiFHLST09}.  Connections to the
literature on {\em view update} in databases are surveyed
in~\cite{Focal2005-shortcite}. \iffull A short version of this paper
appeared in~\cite{HofmannPierceWagner10}.\fi
